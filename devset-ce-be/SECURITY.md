...
This policy applies to the Devset CE backend repository. If you find a vulnerability in a third-party dependency, please report it to the maintainers of that dependency and notify us so we can update.
