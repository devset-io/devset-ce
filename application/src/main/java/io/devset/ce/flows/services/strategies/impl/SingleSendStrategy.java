...
@Slf4j
public class SingleSendStrategy extends AbstractFlowStrategy {

    public SingleSendStrategy(FlowWorkerContext context) {
        super(context);
    }
    ...
    public boolean execute() {
        ...
        log.info("[UI] Send Single Message to Kafka");
        return false;
    }
}
